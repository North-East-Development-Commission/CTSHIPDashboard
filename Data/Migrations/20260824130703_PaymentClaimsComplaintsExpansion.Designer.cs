...
namespace CTSHIPDashboard.Data.Migrations
{
    ...
    [Migration("20260824130703_PaymentClaimsComplaintsExpansion")]
    partial class PaymentClaimsComplaintsExpansion
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CTSHIPDashboard.Models.CapitationPayment", b =>
                {
                    ...
                    b.Property<decimal>("ActualPaymentMade")
                    ...
                    b.Property<DateTime?>("ProviderPaymentReceivedDate")
                        .HasColumnType("date");
                    ...
                    b.HasIndex("ProviderPaymentReceivedDate");
            ...
            modelBuilder.Entity("CTSHIPDashboard.Models.Claim", b =>
                {
                    ...
                    b.Property<decimal>("ApprovedTariff")
                        .HasColumnType("decimal(18,2)");
                    ...
                    b.Property<string>("HmoCertificationNote")
                        .HasMaxLength(1000)
                        .HasColumnType("nvarchar(1000)");

                    b.Property<string>("HmoCertificationStatus")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)")
                        .HasDefaultValue("Not Certified");

                    b.Property<DateTime?>("HmoCertifiedAt")
                        .HasColumnType("datetime2");

                    b.Property<string>("HmoCertifiedBy")
                        .HasMaxLength(200)
                        .HasColumnType("nvarchar(200)");
                    ...
                    b.Property<string>("OriginalProviderDataJson")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.HasIndex("HmoCertificationStatus");
                    ...
                    b.HasIndex("EnrolleeId", "DateOfService", "ServiceProcedure");

                    b.ToTable("Claims");
                });

            modelBuilder.Entity("CTSHIPDashboard.Models.ClaimAuditTrail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("ClaimAuditTrails", (string)null);
                });

            modelBuilder.Entity("CTSHIPDashboard.Models.ClaimQuery", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("ClaimQueries", (string)null);
                });
            ...
            modelBuilder.Entity("CTSHIPDashboard.Models.Complaint", b =>
                {
                    ...
                    b.Property<DateTime?>("AgreedResolutionDueAt")
                        .HasColumnType("datetime2");
                    ...
                    b.Property<string>("CommunicationChannel")
                        ...
                        .HasDefaultValue("In person");

                    b.Property<string>("ComplainantCategory")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)")
                        .HasDefaultValue("Enrollee");
            ...
            modelBuilder.Entity("CTSHIPDashboard.Models.Encounter", b =>
                {
                    ...
                    b.Property<string>("DiagnosisOther")
                        .HasMaxLength(500)
                        .HasColumnType("nvarchar(500)");
                    ...
                    b.Property<string>("ImmunizationsData")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("LaboratoryOther")
                        .HasMaxLength(500)
                        .HasColumnType("nvarchar(500)");

                    b.Property<string>("MedicinesOther")
                        .HasMaxLength(500)
                        .HasColumnType("nvarchar(500)");
                    ...
                    b.Property<string>("PreventiveServicesData")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("PreventiveServicesOther")
                        .HasMaxLength(500)
                        .HasColumnType("nvarchar(500)");
                    ...
                    b.Property<string>("ScreeningTestsData")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("SeenBy")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("SelectedMedicinesData")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("ServicesProvidedOther")
                        .HasMaxLength(500)
                        .HasColumnType("nvarchar(500)");
            ...
            modelBuilder.Entity("CTSHIPDashboard.Models.EncounterPresentingComplaint", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CTSHIPDashboard.Models.LaboratoryService", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("LaboratoryServices", (string)null);
                });
            ...
            modelBuilder.Entity("CTSHIPDashboard.Models.StateOfficeMonthlyReport", b =>
                {
                    ...
                    b.Property<string>("NedcAuditNote")
                        .HasMaxLength(1000)
                        .HasColumnType("nvarchar(1000)");

                    b.Property<string>("NedcAuditStatus")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(50)
                        .HasColumnType("nvarchar(50)")
                    ...
                    b.Property<DateTime?>("NedcAuditedAt")
                        .HasColumnType("datetime2");

                    b.Property<string>("NedcAuditedByName")
                        .HasMaxLength(200)
                        .HasColumnType("nvarchar(200)");

                    b.Property<string>("NedcAuditedByUserId")
                        .HasMaxLength(450)
                        .HasColumnType("nvarchar(450)");
