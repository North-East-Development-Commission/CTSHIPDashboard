...
namespace CTSHIPDashboard.Migrations
{
    ...
    [Migration("20260706031717_AddProviderWalletsAndEncounterWalletSource")]
    partial class AddProviderWalletsAndEncounterWalletSource
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CTSHIPDashboard.Models.Encounter", b =>
                {
                    ...
                    b.Property<string>("WalletSource")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("CTSHIPDashboard.Models.ProviderWallet", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("ProviderWallets", (string)null);
                });

            modelBuilder.Entity("CTSHIPDashboard.Models.ProviderWalletTransaction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("ProviderWalletId")
                        .HasColumnType("int");
                    ...
                    b.ToTable("ProviderWalletTransactions", (string)null);
                });
            ...
            modelBuilder.Entity("CTSHIPDashboard.Models.ProviderWallet", b =>
                {
                    b.HasOne("CTSHIPDashboard.Models.Provider", "Provider")
                        .WithOne("Wallet")
                        .HasForeignKey("CTSHIPDashboard.Models.ProviderWallet", "ProviderId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("CTSHIPDashboard.Models.ProviderWalletTransaction", b =>
                {
                    b.HasOne("CTSHIPDashboard.Models.ProviderWallet", "ProviderWallet")
                        .WithMany("Transactions")
                        .HasForeignKey("ProviderWalletId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.Navigation("ProviderWallet");
                });
